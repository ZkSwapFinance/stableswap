...
import "./ZFStableSwapLP.sol";

contract ZFStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(ZFStableSwapLP).creationCode;
        ...
        ZFStableSwapLP(lpToken).setMinter(_minter);
