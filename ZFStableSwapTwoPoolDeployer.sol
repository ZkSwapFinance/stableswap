...
import "./ZFStableSwapTwoPool.sol";

contract ZFStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(ZFStableSwapTwoPool).creationCode;
        ...
        ZFStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _protocol_fee, _admin, _LP);
